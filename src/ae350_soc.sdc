...
create_clock -name ddr3_memory_clk -period 4 -waveform {0 2} [get_pins {u_Gowin_PLL/PLL_inst/CLKOUT2}]
create_clock -name ddr3_clkin -period 20 -waveform {0 10} [get_pins {u_Gowin_PLL/PLL_inst/CLKOUT0}]
